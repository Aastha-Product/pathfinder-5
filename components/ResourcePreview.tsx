...
import { Star, ChevronRight, Book, Database, Globe, Server, Box, Layout, BarChart, Code, Terminal, Cpu, Bot } from 'lucide-react';
import { CURATED_RESOURCES, POPULAR_ROADMAPS } from '../constants';
...
const ICONS: Record<string, any> = {
    ...
    'Machine Learning Engineer': Bot
};

const COLORS: Record<string, string> = {
    'Python Developer': 'bg-indigo-100 text-indigo-600',
    'SQL Developer': 'bg-blue-100 text-blue-600',
    ...
    'Data Analytics': 'bg-indigo-100 text-indigo-600',
    'Machine Learning Engineer': 'bg-green-100 text-green-600'
};
...
export const ResourcePreview: React.FC<ResourcePreviewProps> = ({ limit, onNavigate, onSearch }) => {
    const displayedResources = limit ? POPULAR_ROADMAPS.slice(0, limit) : POPULAR_ROADMAPS;
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-20">
                    <div className="flex justify-between items-end mb-10">
                        <div>
                            <h2 className="text-3xl font-bold text-text-900">Popular Roadmaps</h2>
                                ...
                                >
                                    ...
                                    <div className="relative h-full bg-white rounded-2xl p-6 border border-slate-100 shadow-sm group-hover:shadow-2xl group-hover:shadow-indigo-500/10 transition-all duration-300 flex flex-col group-hover:-translate-y-1">
                                        ...
                                        <div className="flex gap-2 mb-5">
                                            ...
                                            <span className={`px-2.5 py-1 rounded-md text-xs font-medium border shadow-sm ${resource.level === 'Beginner' ? 'bg-emerald-50 text-emerald-700 border-emerald-100' :
                        ...
                        {popularSkills.map((skill, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    transition={{ delay: i * 0.1 }}
                                    onClick={() => onSearch ? onSearch(skill.title) : (onNavigate && onNavigate('resources'))}
